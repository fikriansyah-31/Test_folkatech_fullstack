...
function StoreLeftComponent() {
    ...
    const [sliderValues, setSliderValues] = useState([25000, 500000]); // Nilai default awal slider
        ...
        <div className='hidden w-[338px] flex-column lg:flex'>
            <Accordion allowMultiple>
                <AccordionItem borderTop={'none'} borderBottom={'none'}>
                    ...
                    <RangeSlider defaultValue={sliderValues} min={0} max={3000000} step={25000} onChange={handleChange}>
